# PENDRAGON CAMPAIGN CODEX — Sir Abisec of Stapleford
...
| Field | Value |
|---|---|
| Player Knight | **Sir Abisec of Stapleford**, called "Shake" |
| Age / Born | **23** / 459 |
...
- **Achil** home to Stapleford (Bascar & Eluned).
...
- **GPC 482 backdrop:** the Summerland agreement (King Cadwy) and sheriffs appointed across Logres.

---

## 3. THE PLAYER KNIGHT — SIR ABISEC OF STAPLEFORD
...
| Lineage | Cymric, of **Sarmatian descent** (Rome's eastern cavalry, settled on the Plain) |
| Religion | **Pagan** (kept quietly at a Christian court) |
| Family arms | A hawk, wings spread, ringed about with icicles |
| Distinctive feature | Eyes so dark they read black; **a hand-wide scar down the breastbone** (the Twelfth Night lance) |
| Current Glory | **~2,494** |
| Economic grade | **Superlative** (castle + lord's maintenance) |
| Bonus Points | Both spent (→ Battle, twice). Next at 3,000 Glory. |

> **Real-world translation:** Abhishek Rao — Indian-American, 30, vascular-surgery resident in Manhattan; reader, action-RPGs & military history, ex-Tae Kwon Do; calm, dry, practical, emotionally contained, blunt when task-focused, gives autonomy to a fault. Brother **Akhil** (med student) ↔ in-game **Achil**; physician parents ↔ Bascar & Eluned.

### 3.2 Attributes & Derived
| SIZ | DEX | STR | CON | APP |
|---|---|---|---|---|
| 11 | **11** | 10 | 14 | **11** |

- **Damage** 4d6 · **Healing Rate** 2 · **Move** 2 · **HP 25/25** (Healthy)
- **Unconscious** ≤6 · **Major Wound** ≥14 (=CON) · **Knockdown** ≥11 (=SIZ) · **Mortal** ≥25 (=HP)
- ⚠ **Maiming (Twelfth Night 481 mortal wound):** DEX 13→11, APP 12→11 (permanent). SIZ 11 = easy to knock down; not a heavy hitter (STR 10). Wins by reach, mobility, skill, and the long game — never a stand-still slug.

### 3.3 Traits (pairs sum 20; **bold = famous 16+**)
| Trait | Opp | | Trait | Opp |
|---|---|---|---|---|
| Chaste 7 | Lustful 13 | | Modest 13 | Proud 7 |
| Energetic 13 | Lazy 7 | | Pious 7 | Worldly 13 |
...
*Read:* blunt-honest, kind, contained, practical/empirical, trusts to a fault, undramatic. **Valorous 16 (famous now)** can seize him toward courage. Modest 13 / Pious 7 → no pagan religious bonus (faith kept quiet).

### 3.4 Passions (**16+ = famous, invokable for +10**)
| Passion | Value | Notes |
|---|---|---|
| **Honor** | **16** | Famous; the engine that drove the trial by combat |
| Loyalty (Count Roderick) | 15 | |
| Love (family) | 15 | "Achil above all" |
| Hospitality | 15 | |
| Hate (Saxons) | 14 | |

### 3.5 Skills (15 competent · 16+ renowned · 20 crits-on-20)
**Combat:** Sword **16** · Lance **16** · Horsemanship **15** · Battle **18** · Spear 6 · Dagger 5
**Notable:** First Aid **15** · Courtesy 13 · Awareness 13 · Intrigue 11 · Falconry 10 · Read[Latin] 8 · Read[Greek] 5
**Low:** Stewardship 3 · Orate 3 · Flirting 3 · Heraldry 3 · Gaming 3 · Recognize 3 · (most lore/social 1–3)

### 3.6 Condition, Horses, Gear
- **HP 25/25, Healthy.** (Survived a mortal wound Twelfth Night 481; nursed back by Eluned's Chirurgery.)
- **Horses:** **Karu** (charger, 6d6) · a **Courser** (6d6, taken at Bedegraine) · 2 Rouncy · Sumpter. *(All survived Winter Phase 481.)*
- **Armor** chainmail (10) · **Shield** (6) · Sword, dagger, 2 spears, lance · fine clothing.
- **Coin:** ~**£144 liquid** war-chest + ~£9 on hand. Father's field-surgery roll; a tiercel (hawk).

### 3.7 Squire — Achil
**Achil** — brother, 16. First Aid 6, Battle 1, Horsemanship 6, Chirurgery 5. **Rescued from Hindon, spring 482**; changed by captivity and by Idris's death; reforged in his "knight who heals" resolve. Knighting ~484–486.

---

## 4. HOLDINGS & ESTATE

### 4.1 Stapleford — the family seat (~£13/yr)
Small moated, palisaded, gated manor on the Wylye. Coneygarth (+£2), armory (+£1). Bascar, Eluned, 2 retained spearmen in residence. Holds the **advowson** of a near-ruined British chapel (Brother Iuan, the tolerant priest; the old harvest rite continues quietly).
...
| Person | Who | State |
|---|---|---|
| **Bascar** | Father, ~60; retired surgeon-knight | Stapleford; "make the silver work" |
| **Eluned** | Mother; sharp, the keeper of the rite; a skilled healer (Chirurgery) | Stapleford; nursed Abisec from the mortal wound; wants him wed |
| **Achil** | Brother/squire, 16; "above all"; the fallback heir | **Rescued, spring 482**; the healer-who-fights |

**No heir yet** — the marriage question (Adwen at Wilton; possibly Senara via Hindon) is the dynastic priority, sharpened by how near Abisec came to dying heirless. Line known for **healing**, and quietly for **books and birds** (falconry & reading family passions; the hawk-and-icicles arms).

---

## 6. THE BOAR CONSPIRACY — RESOLVED (the central arc, 480–482)

**Origin (480):** A royal courier murdered on Salisbury Plain, a sealed dispatch stolen by British-tongued men. Abisec ran them down — the dispatch was Uther's secret **muster-order-and-snare**, testing **two doubted lords**, one a **Boar**. An informant in Roderick's house had warned the Boar early.

**The chain:** Father **Maucan** (Vagon's chaplain-informant) and Sir **Cadeyrn** (the grey-rider handler) — both captured 481, held at Sarum. **Baron Idnerth of Hindon ("the Boar")** — the head.

**The reckoning (Christmas 481 → Twelfth Night):** Abisec won the King's private trust (opposed Honest vs Suspicious), was made the crown's witness, and testified true at the Twelfth Night feast. Idnerth, cornered, **demanded trial by combat** and named Abisec — and **WON it** on a critical lance, dealing Abisec a **mortal wound** (survived, maimed). By God's judgment Idnerth was cleared and freed — a hollow win: the King's doubt became open hatred ("the account is on my ledger").

**The end (spring 482):** Idnerth **abducted Achil** (via a bought groom, Tegid, whom he then silenced — boar-coin on the body). This handed Uther his pretext. Royal commission + the Salisbury host. Abisec **planned & led the storm of Hindon** (morale-erosion + a ram-feint + escalade), **took Idnerth alive** in single combat on the burning wall (lured him up the stair in armour to wind him), and **gave him to the King's justice** — a baron for the scaffold, the public lesson Uther wanted. **Cost: Sir Idris ap Cynan, dead** in the rescue (Abisec's First Aid failed). **The arc is closed.**

**Loose ends:** Cadeyrn & Maucan still imprisoned; the wider spy-network from the ledger not fully rolled up; **the second doubted lord never named** (§7 #13).
...
|---|---|---|
| 1 | Stapleford pagan scandal | CLOSED (481). Iuan installed; rite continues. *Watch Cynfael for any slip.* |
| 2 | Achil | **RESCUED.** Changed; reforged in the healer-who-fights path. Heir restored. |
| 3 | The Boar Conspiracy | **CLOSED** — Idnerth taken alive for the King's justice (see §6). |
| 4 | Old-guard friction | **Thawing.** Even **Caradoc** allows "the boy has bottom" after the trial-by-combat valor. (Generys door may warm.) |
| 5 | The royal secret → **Royal favor** | TURNED. Uther prized Abisec's discretion; counts him a chosen, honest instrument. |
...
**Crown & liege:** **Count Roderick** (liege; deep trust) · **King Uther** (favorable — Abisec's his marked man) · **Duke Ulfius** (Marshal of Logres, Silchester; favorable) · **Sir Brewnor** (royal officer; new crown ally) · **Sir Sadinal** (King's Herald; ally) · **Merlin** (present at court; unmet) · **Brother Syrion** (royal treasurer; the Boar-evidence witness).
...
| Year | Summary | Glory |
|---|---|---|
| 480 | Knighted at Easter; Battle of **Menevia**; the **Plain Sweep** uncovers the Boar plot; Coneygarth | → 1,749 |
| 481 | Stapleford scandal resolved; **Bedegraine** (ransom + a Courser); estate hardened; the **Christmas Court** — won the King's trust, mêlée field; **lost the trial by combat to Idnerth** (mortal wound, maimed); granted **Vagon** | → ~2,344 |
| 481 WP | Sword/Lance → 16; aged 23; Superlative; training → **Valorous 16** | → ~2,448 |
| 482 | **Achil abducted → rescued; the storm of Hindon; Idnerth taken alive; Idris dead.** The Boar arc closed. *(Ongoing.)* | → ~2,494 |

**GPC schedule ahead (for the GM):**
- **482:** Summerland agreement (King Cadwy); sheriffs appointed across Logres.
- **483:** Irish war continues (Gorlois defends Cornwall); the Prince's Passion adventure.
- **484:** Saxon disaster at Eburacum (ambush/defeat) → night victory at Mt. Damen.
- *(…toward 486 Excalibur, 490–491 the Gorlois/Ygraine/Arthur events. Abisec's own arcs — the barony, marriage/dynasty, Senara, the second Boar — overlay these.)*

---

## 10. BINDING GM RULINGS (precedent — keep forever)

1–23 carried from earlier sessions (chargen, combat, interrogation, estate-floor, the KAP 5e personalization/round-to-nearest rules, equivocation/Honesty, the manor advowson, etc. — see `state/session-log.md` for full text). New this arc:

24. **Grand Melee rear charge** is honorable if blows fall on men who turn to meet it; striking unaware backs draws a marshal's foul + Honor check.
25. **Trial by combat:** the *challenged* party chooses arms (per the marshal). A real-combat **critical = double damage** (the tournament "not doubled" rule is jousting-only). Once a combatant is down/incapacitated the verdict is rendered; finishing him is murder, not trial.

---

## 11. GEOGRAPHY (the western march)
