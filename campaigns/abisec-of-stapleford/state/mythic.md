...
- Save point: Christmas Court 481, **Day 5, the tournament** — Abisec just **unhorsed in the first joust course** (bruised, HP 20/25), out of the joust, under the King's eye; the **mêlée** still to come (redemption). Open clocks: **Gwyn dead/silenced** (climb severed) → **Pedr is the sole witness** (guard tripled); **Roderick pulling Bledri today**; the **royal audience** on Uther's clock; the **Boar isolating, cutting threads & likely bolder**; ~5 days to the **Twelfth Night reckoning**.
