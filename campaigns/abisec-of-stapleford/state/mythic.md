...
- Save point: **Spring 482, HINDON (fallen) — the Boar arc CLOSED.** Abisec stormed Hindon, took Idnerth alive for the King's justice (→ scaffold), rescued Achil — at the cost of **Sir Idris dead** (First Aid failed). Hindon (~£230 Baron honour) **forfeit to the Crown**; Abisec the front-runner to be granted it (banneret/baron, on Uther's clock). Glory ~2,494; Valorous 16 (famous); HP 25/25. About to ride home with the dead and the rescued. **Open:** #11 Hindon's disposal / Abisec's elevation; #12 **Lady Senara** (heiress/ward — marriage-pawn or future enemy); #13 the **second doubted lord**; #9 marriage (Adwen at Wilton; Senara possible); ~£144 to invest; **Idris's barrow** & home to Stapleford.
